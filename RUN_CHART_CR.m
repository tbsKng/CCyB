...
for zr = 1:size(data_Se_surprise{1},2)
    ...
    plot(1:1:16,data_Se_surprise{4}(1:16,zr),style{2}, 'color',col{2},'LineWidth', 2,'MarkerSize',2);hold all;
    ...
    ph=plot(1:1:16,data_Se_surprise{1}(1:16,zr),style{1}, 'color',col{1},'LineWidth', 1.5,'MarkerSize',2);hold all;
    % plot(1:1:16,data_Se_CCB_surprise{6}(1:16,zr),style{1}, 'color',col{1},'LineWidth', 2,'MarkerSize',2);hold all;
    plot(1:1:16,data_Se_surprise{2}(1:16,zr),style{4}, 'color',col{4},'LineWidth', 2,'MarkerSize',2);hold all;
    plot(1:1:16,data_Se_surprise{3}(1:16,zr),style{3}, 'color',col{3},'LineWidth', 2,'MarkerSize',2);hold all;
...
saveas(h1,'News_SeQ8_surprise_CR_3DM','fig')
saveas(h1,'News_SeQ8_surprise_CR_3DM','png')
%saveas(h1,'News_SeQ8_surprise_CR_3DM','pdf')
...
for zr = 1:size(data_SmSH_surprise{1},2)
    ...
    plot(1:1:16,data_SmSH_surprise{4}(1:16,zr),style{2}, 'color',col{2},'LineWidth', 2,'MarkerSize',2);hold all;
    ...
    plot(1:1:16,data_SmSH_surprise{1}(1:16,zr),style{1}, 'color',col{1},'LineWidth', 1.5,'MarkerSize',2);hold all;
    plot(1:1:16,data_SmSH_surprise{2}(1:16,zr),style{3}, 'color',col{3},'LineWidth', 2,'MarkerSize',2);hold all;
    plot(1:1:16,data_SmSH_surprise{3}(1:16,zr),style{4}, 'color',col{4},'LineWidth', 2,'MarkerSize',2);hold all;
    line([1 16],[0 0],'color',[0 0 0]); %axis tight;
...
saveas(h1,'News_SmSHQ8_surprise_CR_3DM','fig')
saveas(h1,'News_SmSHQ8_surprise_CR_3DM','png')
%saveas(h1,'News_SmSHQ8_surprise_CR_3DM','pdf')
...
for zr = 1:size(data_SeSF_surprise{1},2)
    ...
    plot(1:1:16,data_SeSF_surprise{4}(1:16,zr),style{2}, 'color',col{2},'LineWidth', 2,'MarkerSize',2);hold all;
    ...
    plot(1:1:16,data_SeSF_surprise{1}(1:16,zr),style{1}, 'color',col{1},'LineWidth', 1.5,'MarkerSize',2);hold all;
    %  plot(1:1:16,data_SeSF_surprise{5}(1:16,zr),style{2}, 'color',col{2},'LineWidth', 1.5,'MarkerSize',2);hold all;
    plot(1:1:16,data_SeSF_surprise{2}(1:16,zr),style{3}, 'color',col{3},'LineWidth', 1.5,'MarkerSize',2);hold all;
    plot(1:1:16,data_SeSF_surprise{3}(1:16,zr),style{4}, 'color',col{4},'LineWidth', 1.5,'MarkerSize',2);hold all;
    
    
    line([1 16],[0 0],'color',[0 0 0]); %axis tight;
    
    if zr==17
        l={'7%','8%','9%','10%'};        lh=legend(l,'Orientation','horizontal');
        sp=get(sh,'position');
        set(lh,'position',[sp(1),sp(2)-.12,sp(3),.1]);
    end
...
saveas(h1,'News_SeSFQ8_surprise_CR_3DM_1','fig')
saveas(h1,'News_SeSFQ8_surprise_CR_3DM_1','png')
%saveas(h1,'News_SeSFQ8_surprise_CR_3DM_1','pdf')
